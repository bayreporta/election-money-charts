	// ------- GLOBAL ------- //
		...
		var gsheet = "https://docs.google.com/spreadsheets/d/1ikFArIjjrXXIBZMRMPS4p7ix2pdXSunVbaf8slnG8Kk/pubhtml"; 
	...
	function drawGeography(){
		...
		if (stacked === 0){
			...
			for (i=0 ; i < raceTotal[race] ;  i++){
				...
				data[i][1] = parseInt(candidateDB[22][ii]);
				data[i][2] = parseInt(candidateDB[23][ii]);
				data[i][3] = parseInt(candidateDB[24][ii]);
